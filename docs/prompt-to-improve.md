...
Now, please `git clone https://github.com/nordeim/markdown-to-html.git` to your local workspace and then meticulously review `AGENTS.md` , `CLAUDE.md` and `README.md` to have a deep understanding of the project and its codebase design and architecture. Next, meticulously plan to review and audit the codebase, then meticulously plan to improve on the codebase to make it more complete and robust and to provide more functionalities that fit into the intended use case of the applicaton.
